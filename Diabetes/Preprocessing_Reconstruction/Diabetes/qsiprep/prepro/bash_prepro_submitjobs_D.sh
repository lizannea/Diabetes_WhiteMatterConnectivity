...
codedir="/fred/oz251/Diabetes/conversion_LA/code/LA/qsiprep/prepro"
logdir="/fred/oz251/Diabetes/derivatives/LA/qsiprep/log/"
...
sbatch ${codedir}/QSIPrep_sbatch_prepro_script_D.sh ${subj_id}
done