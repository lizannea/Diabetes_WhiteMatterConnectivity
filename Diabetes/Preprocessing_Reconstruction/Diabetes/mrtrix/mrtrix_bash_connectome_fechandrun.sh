...
apptainer exec /dagg/public/neuro/neurodesk_20230111/neurocommand/local/containers/mrtrix3_3.0.3_20210917/mrtrix3_3.0.3_20210917.simg bash ${codedir}/mrtrix_sbatch_script_connectome.sh ${subj} |& tee /fred/oz251/Diabetes/derivatives/LA/mrtrix/log/mrtrix_$(date -Iseconds).log
